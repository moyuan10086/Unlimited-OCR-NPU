...
OUT_DIR = Path("/mnt/model/baidu/Unlimited-OCR/benchmarks/OCRBench/str_eval_gpu_params_npu")
...
print(f"request_params={json.dumps(REQUEST_PARAMS, ensure_ascii=False)}", flush=True)
...
for i, row in sub.iterrows():
    ...
    payload = {"image_path": img_path, **REQUEST_PARAMS}
    t0 = time.time()
    try:
